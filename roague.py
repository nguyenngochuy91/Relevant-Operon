...
#    os.system(cmd8)
    ...
    #    ### generate group.txt file to color taxa based on class
        ...
        for file in res:
            ...
            resultDictionary[operon] = [deletion_total,duplication_total,split_total]
            outfile = visualization+operon
            cmd11 = './show_tree.py -i {} -g {} -o {}'.format(file,group,outfile)
            os.system(cmd11)        
        with open("naive_reconstruction_result.txt","w") as outfile:
...
#        os.system(cmd8)
        ...
        for file in res:
            ...
            cmd11 = './show_tree.py -i {} -g {} -o {}'.format(file,group,outfile)
            os.system(cmd11)        
        with open("approx_reconstruction_result.txt","w") as outfile:
            json.dump(resultDictionary,outfile)
